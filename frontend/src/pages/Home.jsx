...
export default function Home() {
  ...
  const steps = [
    {
      icon: <FaHome size={40} />,
      title: "Step 1. Pick a Place You Know",
      description:
        "Choose a familiar place — your home, your school, or your favorite café. ",
      link: "palace/upload"
    },
    {
      icon: <FaBrain size={40} />,
      title: "Step 2. Enter Spots & Topics to Remember",
      description:
    ...
    },
    {
      ...
      title: "Step 3. Generate & Memorize",
      description:
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 flex flex-col items-center p-8 font-sans">
      ...
      {/* Call to Action */}
      <button
        onClick={() => navigate("palace/upload")}
